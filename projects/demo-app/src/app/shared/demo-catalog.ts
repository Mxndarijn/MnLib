...
export const DEMOS: DemoEntry[] = [
  ...
  },
  {
    ...
    color: '#7c3aed',
    abbr: 'SL',
    description: 'Native select with ControlValueAccessor and validation.',
  },
  {
    title: 'Multi-Select',
    ...
    color: '#65a30d',
    abbr: 'MS',
    description: 'Searchable options, max selections, and disabled options.',
  },
  {
    title: 'Checkbox',
    ...
    color: '#22c55e',
    abbr: 'CB',
    description: 'Standalone or forms-bound, with sizes and disabled state.',
  },
  {
    title: 'Datetime',
  ...
  },
  {
    ...
    color: '#d97706',
    abbr: 'FI',
    description: 'Dropzone, thumbnail, list, and compact modes with limits.',
  },
  {
    ...
    color: '#0891b2',
    abbr: 'RT',
    description: 'Quill-backed writing surface with a prose toolbar.',
  },
  ...
  // Actions
  {
    ...
    color: '#3b82f6',
    abbr: 'BT',
    description: 'Buttons and links with sizes, variants, and colors.',
  },
  {
    title: 'Badge',
    ...
    color: '#db2777',
    abbr: 'BG',
    description: 'Status badges with color variants and fills.',
  },
  {
    title: 'Icon',
  ...
  },
  {
    ...
    color: '#16a34a',
    abbr: 'LI',
    description: 'Search, selection, load more, and custom templates.',
  },
  {
    title: 'Grid',
  ...
  // Navigation
  {
    ...
    color: '#f59e0b',
    abbr: 'BC',
    description: 'Linkable trail that degrades to a single Back control.',
  },
  {
    title: 'Tab',
    path: '/demos/tab-demo',
  ...
  },
  {
    ...
    color: '#e11d48',
    abbr: 'DS',
    description: 'Day strip with Today, window arrows, and a date picker.',
  },
  {
    title: 'Calendar',
  ...
  },
  {
    ...
    color: '#94a3b8',
    abbr: 'SK',
    description: 'Loading placeholders you compose to match any layout.',
  },
  {
    title: 'Bottom Sheet',
    path: '/demos/bottom-sheet-demo',
    category: 'Feedback',
    color: '#f43f5e',
    abbr: 'BS',
