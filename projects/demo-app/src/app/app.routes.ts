...
import {FocusCarouselDemo} from './focus-carousel-demo/focus-carousel-demo';
...
export const routes: Routes = [
  ...
  { path: 'demos/focus-carousel-demo', component: FocusCarouselDemo, title: 'Focus Carousel Demo'},
