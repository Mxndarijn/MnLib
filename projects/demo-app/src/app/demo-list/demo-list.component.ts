...
export class DemoListComponent {
  demos: DemoItem[] = [
    ...
    {title: 'Datetime demo', path: '/demos/datetime-demo', description: 'Datetime input with date, time, and datetime-local modes, min/max constraints, and error handling.'}
  ];
}
