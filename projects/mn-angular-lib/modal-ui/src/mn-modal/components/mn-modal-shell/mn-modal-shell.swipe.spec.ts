...
import {ModalBuilder} from 'mn-angular-lib';
import {MnModalRef} from 'mn-angular-lib';
import {CloseMode, ModalConfig} from 'mn-angular-lib';
import {MN_HAPTICS, MnHapticsHandler} from 'mn-angular-lib';
